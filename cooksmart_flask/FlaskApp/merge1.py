...
import sys
import math
MODULE = '/home/jong/Desktop/softdes/SoftDes2015-FinalProject/pattern-2.6'
import sys; 
...
class food2fork:
	...
	def __init__(self,searchdish):
		...
		self.response = urllib2.urlopen('http://food2fork.com/api/search?key='+self.API+'&q='+searchdish).read()
